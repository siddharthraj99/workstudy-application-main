  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Jobs Available", value: jobs.length, icon: "💼", color: "blue" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm">
          ...
          <div className="space-y-2">
            {myApps.length === 0 ? (
              <p className="text-xs text-gray-400 text-center py-6">No applications yet. <button onClick={() => setCurrentPage("jobs")} className="text-blue-500 underline">Browse jobs →</button></p>
            ) : (
